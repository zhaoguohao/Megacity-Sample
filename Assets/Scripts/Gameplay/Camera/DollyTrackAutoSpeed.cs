...
namespace Unity.MegaCity.CameraManagement
{
    ...
    public class DollyTrackAutoSpeed : MonoBehaviour
    {
        ...
        [Range(0, 1)] private float m_ClimbDecelleration = 0.0f;
        ...
        private void TurnSpeedModifier()
        {
            ...
            if (m_CurrentTurnSpeed != m_TargetTurnSpeed)
                m_CurrentTurnSpeed = m_CurrentTurnSpeed +
                                     (m_CurrentTurnSpeed < m_TargetTurnSpeed ? m_TurnAcceleration : -m_TurnBreakForce);
        ...
        private void FallSpeedModifier()
        {
            ...
            if (m_CurrentFallSpeed != m_TargetFallSpeed)
                m_CurrentFallSpeed = m_CurrentFallSpeed +
                                     (m_CurrentFallSpeed < m_TargetFallSpeed
                                         ? m_FallAcceleration
                                         : -m_FallDecelleration);
        ...
        private void ClimbSpeedModifier()
        {
            ...
            m_ClimbDecelleration = 1.0f;

            if (currDollyForward.y >= 0 && currDollyForward.y <= nextDollyForward.y)
            {
                m_ClimbDecelleration = 1 - (dollyForwardYDiff * m_ClimbModifier);
            }
        }
        ...
        private void FixedUpdate()
        {
            ...
            float targetSpeed = m_BaseSpeed * m_TargetFallSpeed * m_ClimbDecelleration * m_CurrentTurnSpeed;
            ...
            if (m_EnableDebugText)
            {
                ...
                Debug.Log("m_ClimbDecelleration: " + m_ClimbDecelleration);
